          ...
          <Work
            ...
            statement={
              <>
                ...
                <p>
                  初出場のハッカソンで、2日間で作り上げました。同じく初出場メンバー計4人でチームを作成し、リーダーとして環境構築からコーディング、レビューまで行いました。世界大会に出場します。
                </p>
                <p>詳細は<a href="https://github.com/yudai1204/nasa-hackathon-2023-yokohama">GitHubレポジトリ</a>をご確認ください。</p>
              </>
            }
            links={[
              {
